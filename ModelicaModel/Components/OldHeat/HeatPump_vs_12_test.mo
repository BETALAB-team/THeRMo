...
model HeatPump_vs_12_test "Using UAeff for Condenser and Evaporator"
  ...
  Heating.Condenser_vs_3_UAeff Condenser(
  ...
  Heating.Evaporator_vs_2_UAeff Evaporator(
...
equation
  ...
  connect(Evaporator.port_b, Source_out) annotation (Line(points={{58,-71},{58,
          -70},{70,-70},{70,-110}},
                               color={0,127,255}));
  connect(Condenser.RefT,CMP_8. Tcond) annotation (Line(points={{29.9,58.2},{
          -20,58.2},{-20,13.8}},
                             color={0,0,127}));
  connect(COP, COP)
  ...
  connect(gain.y, Evaporator.HeatFlow)
    annotation (Line(points={{43,-38.3},{38.65,-38.3},{38.65,-54.35}},
                                                     color={0,0,127}));

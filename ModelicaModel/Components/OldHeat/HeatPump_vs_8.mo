...
model HeatPump_vs_8
  "Integration with first order filter to smooth the passage from ON to OFF and viceversa"
...
equation
  ...
  connect(Condenser.RefT, ref_cycle_vs_8.Tcond) annotation (Line(points={{65.5,
          64.5},{-10,64.5},{-10,14},{21.96,14},{21.96,12.3}}, color={0,0,127}));
  connect(COP, COP)
  ...
  connect(onOff_vs_4_1.Output,CMP_7. CMP_f) annotation (Line(points={{-43.4,

...
model Evaporator_vs_2_inverse "Direct calculation of Heat Flow"
  ...
  Real Tsat( unit = "K", start = 293.15,min = 200,max = 340) "refrigerant temperature";
  //Real Ratio "Ratio between CC and m";
   Modelica.Blocks.Continuous.FirstOrder firstOrder(u = Tsat,
...
equation
  ...
  HeatFlow = efficiency *m_flow_safe*cp *(SensEF.T - Tsat);
  ...
  connect(RefT, firstOrder.y) annotation (Line(points={{-110,70},{-38,70},{-38,
          52},{-43,52}},        color={0,0,127}));
  annotation (

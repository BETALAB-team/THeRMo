...
model Condenser_vs_3_inverse "Direct formulation of Heat flow"
  ...
  Real Tsat(  unit   = "K",start = 293.15,min = 200,max = 340) "refrigerant saturation temperature";
...
equation
  ...
  HeatFlow = efficiency * m_flow_safe*cp *(Tsat - SensEF.T);

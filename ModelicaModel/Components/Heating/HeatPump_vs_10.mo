...
model HeatPump_vs_10
  "Added filter on condenser and evaporation refrigerant temperature"
  ...
  Condenser_variable_UA_rel_fil Condenser(
  ...
  parameter Real UA_nom "Nominal UA value"
    annotation (Dialog(group="Condenser"));
  parameter Modelica.Units.SI.Time T_cost_cond( displayUnit="min") =900 "Time Constant of Cond Filter"
    annotation (Dialog(group="Condenser"));
  parameter Modelica.Units.SI.Time T_cost_eva( displayUnit="min") =900 "Time Constant of Eva Filter"
    annotation (Dialog(group="Evaporator"));
...
equation
  ...
  connect(Evaporator.port_b, Source_out) annotation (Line(points={{54,-71},{54,
          -70},{70,-70},{70,-110}},
                               color={0,127,255}));
  connect(Condenser.RefT,CMP_8. Tcond) annotation (Line(points={{65.5,64.5},{-20,
  ...
  connect(onOff_vs_4_1.Output,CMP_8. CMP_f) annotation (Line(points={{-43.4,3.32},
          {-40,3.32},{-40,3.15},{-36.2,3.15}}, color={0,0,127}));
  connect(onOff_vs_4_1.OnOff,CMP_8. Mode) annotation (Line(points={{-43.4,-6.2},
          {-43.4,-6},{-40,-6},{-40,-9.15},{-36.2,-9.15}}, color={255,127,0}));
  ...
  connect(Condenser.HC_secondary, division.u1) annotation (Line(points={{65.5,
          58.5},{72,58.5},{72,45.2},{78.6,45.2}}, color={0,0,127}));

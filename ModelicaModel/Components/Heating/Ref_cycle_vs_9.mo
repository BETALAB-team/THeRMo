...
model Ref_cycle_vs_9 "Added variable SH calculation"
  ...
  Modelica.Blocks.Interfaces.RealInput Wel_map(unit="W") "compressor power" annotation (Placement(transformation(extent={{-124,16},{-100,40}}), iconTransformation(extent={{-124,16},{-100,40}})));
  Modelica.Blocks.Interfaces.RealOutput HC_ref(unit="W") "heating capacity calculated with refrigerant cycle" annotation (Placement(transformation(
        extent={{20,-20},{-20,20}},
        rotation=-90,
        ...
        rotation=-90,
        origin={0,114})));
  Modelica.Blocks.Interfaces.RealInput CC_map(unit="W") "Cooling capacity in standardised conditions"
    annotation (Placement(transformation(extent={{-124,-42},{-100,-18}}), iconTransformation(extent={{-124,-42},{-100,-18}})));
  Modelica.Blocks.Interfaces.RealOutput CC_ref(unit="W") "heating capacity calculated with refrigerant cycle" annotation (Placement(transformation(
        extent={{-21,-21},{21,21}},
        rotation=-90,
  ...
  Modelica.Blocks.Interfaces.RealOutput COP "Coeffiicent of performance of the Heat Pump"
  ...
  Modelica.Blocks.Interfaces.IntegerInput OnOff annotation (Placement(transformation(extent={{-124,-12},{-100,12}}), iconTransformation(extent={{-124,-12},{-100,12}})));

  Modelica.Blocks.Interfaces.RealOutput M_ref=m_ref annotation (Placement(transformation(
        extent={{-12,-12},{12,12}},
        rotation=90,
        origin={78,114}), iconTransformation(
        extent={{-12,-12},{12,12}},
        rotation=90,
        origin={78,114})));
...
equation
  ...
  COP = Buildings.Utilities.Math.Functions.smoothMax(
    HC_ref/Wel_ref,
    1e-4,

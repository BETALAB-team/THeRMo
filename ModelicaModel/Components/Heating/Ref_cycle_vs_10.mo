...
model Ref_cycle_vs_10 "Remove integer calculation"
  ...
  Modelica.Blocks.Interfaces.RealInput  CC_Wel[2]( unit="W") "Cooling capacity and Wel in standardised conditions"
    annotation (Placement(transformation(extent={{-126,-12},{-102,12}}),  iconTransformation(extent={{-126,-12},{-102,12}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput HC_tot[2]={HC_ref,m_ref} "CC refrigerant and refrigerant mass flow rate" annotation (Placement(transformation(
        extent={{-13,-13},{13,13}},
        rotation=90,
...
equation
 ...
 //-------------- Calculation of percentage of heat exchanged in condensation and evaporation------------------------------------------------------------------------------------------------------
  ...
  connect(CC_Wel, deMultiplex2.u) annotation (Line(points={{-114,0},{-73.2,0}},   color={0,0,127}));
  annotation (
    Icon(graphics={
        Rectangle(

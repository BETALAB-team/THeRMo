...
model CMP_poly_vs_8_clean "Added softStart directly on starter filter"
  ...
  //------------------Fixed speed poly-------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Modelica.Blocks.Interfaces.RealInput CMP_f(unit="Hz")
    "Compressor frequency / speed " annotation (Placement(transformation(extent={{-142,4},
            {-102,44}}),iconTransformation(extent={{-126,6},{-100,32}})));

   //------------------Input and output blocks------------------------------------------------------------------------------------------------------------------------------------------------------

  Modelica.Blocks.Interfaces.IntegerInput Mode "operating mode" annotation (Placement(transformation(extent={{-126,-34},{-100,-8}}),
  ...
  Modelica.Blocks.Interfaces.IntegerOutput Mode_Output = Mode annotation (Placement(
        transformation(extent={{100,-36},{132,-4}}),
                                                  iconTransformation(extent={{100,-36},{132,-4}})));
 ...
 //------------------Polynomial output calculation-------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  elseif CMP_type == "Variable speed 30 coeff" then
    ...
    annotation (Placement(transformation(extent={{-126,-114},{-86,-74}})),
              Icon(coordinateSystem(preserveAspectRatio=false), graphics={Bitmap(extent={{-90,-96},{94,94}}, fileName="modelica://HeatPumpModel/../Incons/Copia di Compressor.png"),
                                                                                                                                                                            Text(
          extent={{-62,-74},{66,-112}},
          textColor={0,0,255},

...
model Ref_cycle_vs_10_cooling "Erase integer"
  ...
  Modelica.Blocks.Interfaces.RealOutput CC_tot[2]={CC_ref,m_ref} "CC refrigerant and refrigerant mass flow rate" annotation (Placement(transformation(
        extent={{-13,-13},{13,13}},
        rotation=90,
...
equation
 ...
 //-------------- Calculation of Energy Balances--------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  connect(CC_Wel, deMultiplex2.u) annotation (Line(points={{-114,0},{-96,0},{-96,20},{-77.2,20}},
                                                                                  color={0,0,127}));
  annotation (
    Icon(graphics={
        Rectangle(

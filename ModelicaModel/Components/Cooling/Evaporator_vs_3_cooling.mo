...
model Evaporator_vs_3_cooling "This class corresponds to the Condenser_vs_3 class, but it is implemente for the cooling mode. Thus, it becomes the Evapoator"
...
equation
  ...
  connect(deMultiplex2.u, CC_tot) annotation (Line(points={{32,-97.2},{32,-104},{32,-112},{0,-112}},
                                                                                  color={0,0,127}));
  ...
  connect(deMultiplex2.y1[1], gain.u) annotation (Line(points={{28.4,-83.4},{28.4,-77},{9,-77}}, color={0,0,127}));

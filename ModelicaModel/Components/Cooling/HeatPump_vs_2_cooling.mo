...
model HeatPump_vs_2_cooling

  CMP_poly_vs_9_cooling cMP_poly_vs_9_cooling(fileName=fileName, CMP_type=CMP_type, minF = minF) annotation (Placement(transformation(extent={{-48,-16},{-14,16}})));
  Ref_cycle_vs_10_cooling ref_cycle_vs_10_cooling(
  ...
  Modelica.Blocks.Interfaces.RealInput CMP_f "Compressor frequency / speed " annotation (Placement(transformation(extent={{-112,-6},{-100,6}}),  iconTransformation(extent={{-112,-6},{-100,6}})));
  ...
  Heating.Dew_T_calculation
                    dew_T_calculation(redeclare package Medium = Medium) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={-30,38})));
...
equation
  ...
  connect(cMP_poly_vs_9_cooling.CC_Wel, ref_cycle_vs_10_cooling.CC_Wel) annotation (Line(points={{-11.62,0},{-11.62,1},{27.9,1}}, color={0,0,127}));
  ...
  connect(CondCool.RefT,cMP_poly_vs_9_cooling. Tcond) annotation (Line(points={{29.7,-54.5},{-31,-54.5},{-31,-18.24}}, color={0,0,127}));
  ...
  connect(cMP_poly_vs_9_cooling.CMP_f, CMP_f) annotation (Line(points={{-50.21,-0.16},{-52,0},{-106,0}},             color={0,0,127}));
  ...
  connect(dew_T_calculation.T_dew, cMP_poly_vs_9_cooling.Teva) annotation (Line(points={{-30,26.2},{-30.83,26},{-30.83,18.08}}, color={0,0,127}));
  connect(ref_cycle_vs_10_cooling.Teva, cMP_poly_vs_9_cooling.Teva) annotation (Line(points={{28.2,10.3},{-8,10.3},{-8,18.08},{-30.83,18.08}}, color={0,0,127}));
  connect(EvaCool.RefT, dew_T_calculation.T_eva_in) annotation (Line(points={{29.7,55.8},{-24,55.8},{-24,56},{-30,56},{-30,50}}, color={0,0,127}));

...
model HeatPump_vs_6_UA_nom
  "Added control of the thermodynamics powers after the refrigerant calulations and efficencies of HEs calculated usign UA_nom"
  Ref_cycle_vs_5 ref_cycle_vs_5_1(
    fileName=fileName,
    SH=SH,
    SBC=SBC,
  ...
  EvaporatorCondenserFixedTempFlow_UA_nom
    ...
    UA_nom=UA_cond)                  annotation (Placement(transformation(extent={{34,54},{64,84}})));
  EvaporatorCondenserFixedTempFlow_UA_nom
                                Evaporator(
  ...
  Modelica.Blocks.Math.Gain gain(k=-1) annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={34,-38})));
  parameter Real UA_cond=1000 "Heat transfer/ area product"
...
equation
  ...
  connect(ref_cycle_vs_5_1.Wel_ref, Wel_ref) annotation (Line(points={{61.91,
          3.29},{100,3.29},{100,16},{116,16}}, color={0,0,127}));

  connect(ref_cycle_vs_5_1.COP, COP) annotation (Line(points={{61.91,-7.93},{
          100,-7.93},{100,-20},{110,-20},{110,-22},{118,-22}}, color={0,0,127}));
  connect(CMP_5.Mode_Output, ref_cycle_vs_5_1.OnOff) annotation (Line(points={{
          -4.2,-2.85},{8,-2.85},{8,-3},{21.96,-3}}, color={255,127,0}));
  connect(CMP_5.m_ref, ref_cycle_vs_5_1.m_ref_map) annotation (Line(points={{-4.2,
          -7.05},{-4.2,-8.1},{21.96,-8.1}}, color={0,0,127}));
  connect(CMP_5.Wel, ref_cycle_vs_5_1.Wel_map) annotation (Line(points={{-4.4,
          1.5},{-8,1.76},{21.96,1.76}}, color={0,0,127}));
  connect(ref_cycle_vs_5_1.HC_ref, Condenser.HeatFlow) annotation (Line(points=
          {{41.17,17.91},{43.45,17.91},{43.45,52.95}}, color={0,0,127}));
  ...
  connect(Evaporator.port_b, Source_out) annotation (Line(points={{54,-71},{54,
          -70},{70,-70},{70,-110}},
                               color={0,127,255}));
  connect(Condenser.RefT, CMP_5.Tcond) annotation (Line(points={{65.5,61.2},{
          -20,61.2},{-20,13.8}},
                             color={0,0,127}));
  connect(Condenser.RefT, ref_cycle_vs_5_1.Tcond) annotation (Line(points={{65.5,
          61.2},{-10,61.2},{-10,12},{21.96,12},{21.96,12.3}},      color={0,0,
          127}));
  connect(COP, COP)
    annotation (Line(points={{118,-22},{118,-22}}, color={0,0,127}));
  connect(DewT.T_dew, CMP_5.Teva) annotation (Line(points={{-15.44,-56},{-20,
          -56},{-20,-18}},      color={0,0,127}));
  connect(onOff_vs_4_1.Output, CMP_5.CMP_f) annotation (Line(points={{-43.4,1.36},
          {-40,1.36},{-40,3.15},{-36.2,3.15}}, color={0,0,127}));
  connect(onOff_vs_4_1.OnOff, CMP_5.Mode) annotation (Line(points={{-43.4,-6.2},
  ...
  connect(ref_cycle_vs_5_1.CC_ref, gain.u) annotation (Line(points={{41.17,
          -23.91},{34,-23.91},{34,-33.2}},
                                   color={0,0,127}));
  ...
  connect(gain.y, Evaporator.HeatFlow)
    annotation (Line(points={{34,-42.4},{33.45,-42.4},{33.45,-54.95}},
                                                     color={0,0,127}));
  connect(DewT.T_dew, ref_cycle_vs_5_1.Teva) annotation (Line(points={{-15.44,
          -56},{-20,-56},{-20,-26},{12,-26},{12,-17.96},{21.96,-17.96}}, color=
          {0,0,127}));

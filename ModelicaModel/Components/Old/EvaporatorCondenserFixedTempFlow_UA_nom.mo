...
model EvaporatorCondenserFixedTempFlow_UA_nom
...
equation
  m_flow_safe  = Buildings.Utilities.Math.Functions.smoothMax(abs(port_a.m_flow), m_flow_small, m_flow_small/10);
...
end EvaporatorCondenserFixedTempFlow_UA_nom;

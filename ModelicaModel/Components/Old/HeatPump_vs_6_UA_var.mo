...
model HeatPump_vs_6_UA_var
  ...
  Ref_cycle_vs_6 ref_cycle_vs_6_1(
    fileName=fileName,
    SH=SH,
    SBC=SBC,
...
equation
  ...
  connect(ref_cycle_vs_6_1.Wel_ref, Wel_ref) annotation (Line(points={{61.91,8.73},
          {100,8.73},{100,16},{116,16}},       color={0,0,127}));

  connect(ref_cycle_vs_6_1.COP, COP) annotation (Line(points={{61.91,-14.05},{100,
          -14.05},{100,-20},{110,-20},{110,-22},{118,-22}},    color={0,0,127}));
  connect(CMP_5.Mode_Output,ref_cycle_vs_6_1. OnOff) annotation (Line(points={{
          -4.2,-2.85},{8,-2.85},{8,-3},{21.96,-3}}, color={255,127,0}));
  connect(CMP_5.m_ref,ref_cycle_vs_6_1. m_ref_map) annotation (Line(points={{-4.2,
          -7.05},{-4.2,-8.1},{21.96,-8.1}}, color={0,0,127}));
  connect(CMP_5.Wel,ref_cycle_vs_6_1. Wel_map) annotation (Line(points={{-4.4,
          1.5},{-8,1.76},{21.96,1.76}}, color={0,0,127}));
  connect(ref_cycle_vs_6_1.HC_ref, Condenser.HeatFlow) annotation (Line(points={{41.17,
  ...
  connect(Evaporator.port_b, Source_out) annotation (Line(points={{54,-71},{54,
          -70},{70,-70},{70,-110}},
                               color={0,127,255}));
  connect(Condenser.RefT, CMP_5.Tcond) annotation (Line(points={{65.5,64.5},{-20,
          64.5},{-20,13.8}}, color={0,0,127}));
  connect(Condenser.RefT,ref_cycle_vs_6_1. Tcond) annotation (Line(points={{65.5,
          64.5},{-10,64.5},{-10,12},{21.96,12},{21.96,12.3}},      color={0,0,
          127}));
  connect(COP, COP)
  ...
  connect(ref_cycle_vs_6_1.CC_ref, gain.u) annotation (Line(points={{41.17,
  ...
  connect(gain.y, Evaporator.HeatFlow)
    annotation (Line(points={{34,-42.4},{33.45,-42.4},{33.45,-54.95}},
                                                     color={0,0,127}));
  connect(DewT.T_dew,ref_cycle_vs_6_1. Teva) annotation (Line(points={{-15.44,
          -56},{-20,-56},{-20,-26},{12,-26},{12,-17.96},{21.96,-17.96}}, color=
          {0,0,127}));
  connect(ref_cycle_vs_6_1.M_ref, Condenser.m_ref) annotation (Line(points={{61.4,
          -3.34},{80,-3.34},{80,46},{54.85,46},{54.85,52.35}}, color={0,0,127}));

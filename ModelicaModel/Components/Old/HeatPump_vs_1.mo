...
model HeatPump_vs_1
  "BaseHP with poly calculations combined with refrigerant cycle - Trasposition of TRNSYS Type"
  ...
  redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{30,-28},{84,26}})));
...
equation
  connect(baseHP_vs_3.Wel, ref_cycle_vs_2.Wel) annotation (Line(points={{-12.24,
          5.86},{-12.24,6.02},{26.76,6.02}},         color={0,0,127}));
  connect(baseHP_vs_3.m_ref, ref_cycle_vs_2.m_ref) annotation (Line(points={{-11.6,
          -6.56},{26,-6.56},{26,-6.4},{26.76,-6.4}},     color={0,0,127}));
  connect(ref_cycle_vs_2.HC_ref, HC_ref) annotation (Line(points={{90.21,14.39},
          {90.21,30},{110,30}}, color={0,0,127}));
  connect(baseHP_vs_3.Load_in, Load_in) annotation (Line(points={{-58.32,30.7},{
          -58.32,92},{-70,92},{-70,110}}, color={0,127,255}));
  connect(baseHP_vs_3.Load_out, Load_out) annotation (Line(points={{-40.4,30.7},
          {-40.4,62},{-40,62},{-40,92},{70,92},{70,110}}, color={0,127,255}));
  connect(Load_in, Load_in)
    annotation (Line(points={{-70,110},{-70,110}}, color={0,127,255}));
  connect(baseHP_vs_3.Source_in, Source_in) annotation (Line(points={{-56.4,-29.24},
          {-56.4,-64},{-70,-64},{-70,-110}}, color={0,127,255}));
  connect(baseHP_vs_3.Source_out, Source_out) annotation (Line(points={{-37.2,-29.24},
  ...
  connect(ref_cycle_vs_2.CC_ref, CC_ref) annotation (Line(points={{90.21,-12.07},
          {90,-12.07},{90,-30},{110,-30}}, color={0,0,127}));
  connect(OnOff, baseHP_vs_3.OnOff) annotation (Line(points={{-113,-1},{-88,-1},
          {-88,0},{-89.68,0},{-89.68,1}}, color={255,127,0}));
  connect(baseHP_vs_3.HC, ref_cycle_vs_2.HC) annotation (Line(points={{-11.6,14.5},
          {-10,13.58},{26.76,13.58}}, color={0,0,127}));
  connect(baseHP_vs_3.Tcond, ref_cycle_vs_2.Tcond) annotation (Line(points={{-12.24,
          22.6},{-10,22.76},{26.76,22.76}}, color={0,0,127}));
  connect(baseHP_vs_3.Teva, ref_cycle_vs_2.Teva) annotation (Line(points={{
          -11.6,-22.22},{-11.6,-22},{24,-22},{24,-24},{26.76,-24},{26.76,-23.14}},
        color={0,0,127}));
  connect(baseHP_vs_3.CC, ref_cycle_vs_2.CC) annotation (Line(points={{-11.6,
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
        Rectangle(
          ...
          lineThickness=1),
        Bitmap(extent={{-96,-72},{96,94}}, fileName="modelica://HeatPumpModel/../Incons/Immagine 2025-11-14 130229.png"),
        Text(
          extent={{-58,-62},{84,-106}},
          textColor={0,0,0},
          textString="%name

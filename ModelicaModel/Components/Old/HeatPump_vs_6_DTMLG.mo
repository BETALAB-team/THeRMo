...
model HeatPump_vs_6_DTMLG
  "Added control of the thermodynamics powers after the refrigerant calulations and variable HE efficencies"
  ...
  Dew_T_calculation DewT( redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{10,-64},{-6,-48}})));
...
equation
  ...
  connect(ref_cycle_vs_4.HC_ref, Condenser.HeatFlow) annotation (Line(points={{41.17,
          17.91},{43.6,17.91},{43.6,52.5}},    color={0,0,127}));
  ...
  connect(Evaporator.port_a, Source_in) annotation (Line(points={{24,-69},{24,-70},
          {-70,-70},{-70,-110}}, color={0,127,255}));
  connect(Evaporator.port_b, Source_out) annotation (Line(points={{54,-69},{54,-70},
          {70,-70},{70,-110}}, color={0,127,255}));
  connect(Condenser.RefT, CMP_5.Tcond) annotation (Line(points={{32.5,56.7},{-20,
          56.7},{-20,13.8}}, color={0,0,127}));
  connect(Condenser.RefT, ref_cycle_vs_4.Tcond) annotation (Line(points={{32.5,56.7},
          {-10,56.7},{-10,12},{21.96,12},{21.96,12.3}}, color={0,0,127}));
  connect(COP, COP)
    annotation (Line(points={{118,-22},{118,-22}}, color={0,0,127}));
  connect(DewT.T_dew, ref_cycle_vs_4.Teva) annotation (Line(points={{-7.44,-56},
          {-20,-56},{-20,-26},{12,-26},{12,-17.96},{21.96,-17.96}},
                                                            color={0,0,127}));
  connect(DewT.T_dew, CMP_5.Teva) annotation (Line(points={{-7.44,-56},{-20,-56},
          {-20,-18}},           color={0,0,127}));
  ...
  connect(ref_cycle_vs_4.CC_ref, gain.u) annotation (Line(points={{41.17,-23.91},
          {48,-23.91},{48,-35.2}}, color={0,0,127}));
  connect(Evaporator.RefT, DewT.T_eva_in) annotation (Line(points={{22.5,-56.7},
          {22.5,-56},{11.6,-56}}, color={0,0,127}));
  connect(gain.y, Evaporator.HeatFlow)
    annotation (Line(points={{48,-44.4},{48,-48},{48,-52.5},{33.6,-52.5}},
                                                     color={0,0,127}));

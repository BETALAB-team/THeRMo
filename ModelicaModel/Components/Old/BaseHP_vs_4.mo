...
model BaseHP_vs_4
  "Added Calculation of Dew Point temperature at Evaporator"
...
equation
  ...
  connect(CMP_2.HC, Condenser.HeatFlow) annotation (Line(points={{13.5,20.72},{13.5,
          28},{-0.25,28},{-0.25,41.25}}, color={0,0,127}));
  connect(HC, CMP_2.HC) annotation (Line(points={{120,50},{92,50},{92,28},{13.5,
          28},{13.5,20.72}}, color={0,0,127}));
  connect(CMP_2.Wel, Wel) annotation (Line(points={{22,5.6},{92,5.6},{92,18},{118,
          18}}, color={0,0,127}));
  connect(CMP_2.m_ref, m_ref) annotation (Line(points={{22,-1.6},{92,-1.6},{92,-28},
          {120,-28}}, color={0,0,127}));
  connect(CMP_2.CC, Evaporator.HeatFlow) annotation (Line(points={{14,-14.56},{14,
          -28},{1.75,-28},{1.75,-45.25}}, color={0,0,127}));
  connect(CMP_2.Tcond, Condenser.RefT) annotation (Line(points={{-19.5,-1.24},{-62,
          -1.24},{-62,46},{-10,46},{-10,45.9},{20.9,45.9}}, color={0,0,127}));
  connect(OnOff, CMP_2.Mode) annotation (Line(points={{-124,0},{-92,0},{-92,16.04},
          {-19.5,16.04}}, color={255,127,0}));
  ...
  connect(gain.u, Evaporator.HeatFlow) annotation (Line(points={{78.6,-59},{78.6,
          -48},{78,-48},{78,-26},{1.75,-26},{1.75,-45.25}}, color={0,0,127}));
  connect(DewT.T_dew, CMP_2.Teva) annotation (Line(points={{-59,-14.2},{-60,-14.2},
          {-60,-9.16},{-19.5,-9.16}}, color={0,0,127}));
  connect(DewT.T_eva_in, Evaporator.RefT) annotation (Line(points={{-59,-38},{-62,
          -38},{-62,-50},{20,-50},{20,-49.9},{22.9,-49.9}},
        color={0,0,127}));

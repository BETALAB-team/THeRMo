...
model BaseHP_Test_vs_4 "Test BaseHP with constant input and variable speed amd smooth function"
  import Modelica;
  Components.BaseHP_vs_5 baseHP_vs_5_1(
    ...
    dp__eva_nominal=0,
    fileName=
        "C:/Users/benafra10167/Desktop/CMP_polynomial/Variable_Speed_Danfoss/VRJ028-K polynomials.xls",
...
equation
  connect(Load.ports[1], baseHP_vs_5_1.Load_in) annotation (Line(points={{-22,
          28},{9.62,28},{9.62,11.2}}, color={0,127,255}));
  connect(Source.ports[1], baseHP_vs_5_1.Source_in) annotation (Line(points={{-24,
          -32},{10.4,-32},{10.4,-15.44}}, color={0,127,255}));
  connect(Load_Volume.ports[1], baseHP_vs_5_1.Load_out) annotation (Line(points
        ={{20,58},{28,58},{28,11.2},{16.9,11.2}}, color={0,127,255}));
  connect(Source_Volume.ports[1], baseHP_vs_5_1.Source_out) annotation (Line(
        points={{44,-48},{48,-48},{48,-20},{18.2,-20},{18.2,-15.44}}, color={0,
          127,255}));
  connect(baseHP_vs_5_1.Source_out, T_source_out.port) annotation (Line(points=
          {{18.2,-15.44},{18.2,-20},{48,-20},{48,-30},{80,-30},{80,-24}}, color
        ={0,127,255}));
  connect(T_load_out.port, baseHP_vs_5_1.Load_out) annotation (Line(points={{78,
          18},{78,11.2},{16.9,11.2}}, color={0,127,255}));
  connect(Frequency.y, baseHP_vs_5_1.CMP_frequency) annotation (Line(points={{
          -61,0},{-3.12,0},{-3.12,1.36}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)),
    experiment(StopTime=8600, __Dymola_Algorithm="Dassl"));
end BaseHP_Test_vs_4;

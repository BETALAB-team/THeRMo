...
model HP_Test_vs_2 "Test HP with Dabiri correlations with costant temperatures supplied"
  Components.HeatPump_vs_2 heatPump_vs_2(
    redeclare package Medium = ExternalMedia.Media.CoolPropMedium (mediumName=
            "R290", substanceNames={"R290"}) "R290",
...
equation
  ...
  connect(realToInteger1.y, heatPump_vs_2.OnOff) annotation (Line(points={{-65.5,
  ...
  connect(Source.ports[1], heatPump_vs_2.Source_in) annotation (Line(points={{-32,
          -66},{-13.3,-66},{-13.3,-30.6}}, color={0,127,255}));
